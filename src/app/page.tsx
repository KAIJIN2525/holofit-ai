            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="relative aspect-square max-w-lg mx-auto">
                <div className="relative overflow-hidden rounded-lg bg-cyber-black">
                  <img src="/hero-ai4.png" alt="AI Fitness Coach" className="size-full object-cover object-center" />
                  ...
                  <div className="absolute inset-0 pointer-events-none">
                    ...
                    {/* Targeting lines */}
                    <div className="absolute top-1/2 left-0 w-1/4 h-1 rounded-full bg-primary/50"/>
                    <div className="absolute top-1/2 right-0 w-1/4 h-1 rounded-full bg-primary/50"/>
                    <div className="absolute top-0 left-1/2 h-1/4 w-px rounded-full bg-primary/50"/>
                    <div className="absolute bottom-0 left-1/2 h-1/4 w-px rounded-full bg-primary/50"/>
                  </div>
