            ...
            <div className="flex flex-wrap gap-2">
              {allPlans.map(plan => (
                ...
                >
                  {plan.name}
                  {plan.isActive && (
                    <span className="ml-2 bg-green-500/20 text-green-500 px-2 py-0.5 rounded">ACTIVE</span>
                  )}
                </Button>
              ))}
            </div>
                                ...
                                >
                                  <div className="flex justify-between items-start mb-2">
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      <div className="px-2 py-1 rounded bg-primary/20 text-secondary text-xs font-medium">
                                        {routine.reps} REPS
                                      </div>
                                    </div>
                                  </div>
